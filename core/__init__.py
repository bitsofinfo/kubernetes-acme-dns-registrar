...
class RegistrarService(Thread, HealthcheckParticipant):
    ...
    def init_k8s_watcher_service(self):
        ...
        return K8sWatcherService(k8s_config_file_path=k8s_settings.KADR_K8S_WATCHER_CONFIG_FILE_PATH,
                                 k8s_config_context_name=k8s_settings.KADR_K8S_WATCHER_CONTEXT_NAME) \
